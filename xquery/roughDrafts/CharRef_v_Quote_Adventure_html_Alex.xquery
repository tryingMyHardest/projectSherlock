...
declare variable $numQuote := $quotes => count();

<html>
<head>
<title>Alex Doran</title>
<link rel="stylesheet" href="HolmesCSS.css"/>
</head>
<body>
<div>
<svg alignment-baseline="baseline" viewport="0 0 1500 {$numChar*30}" xmlns="http://www.w3.org/2000/svg" width="1500" height="{$numChar*30}">
        <g>
           {
